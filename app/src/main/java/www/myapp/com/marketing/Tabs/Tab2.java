...
import www.myapp.com.marketing.customitem.chat_adapter;

import static www.myapp.com.marketing.activities.Comments.phone;
...
public class Tab2 extends Fragment {
    ...
    ArrayList<chat_item> array = new ArrayList<chat_item>();

    RecyclerView recyclerView;
    String url = "http://hassan-elkhadrawy.000webhostapp.com/displayitems.php";
    String phone;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclelistcating);
        select();
        return view;
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                String image = getData.getString("p_image");

                                array.add(new chat_item(name, username, image));


                            }

                            chat_adapter = new chat_adapter(getActivity(), array);
